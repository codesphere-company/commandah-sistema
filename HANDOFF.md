...
Última atualização: **2026-09-24** (cancelar item/comanda com permissão por login + carrinho no "Adicionar produto direto" + histórico da comanda agrupado por pedido — os três testados e confirmados pelo Fabricio no localhost, ver seções próprias; aguardando merge do PR #27 em `main` pra ir ao ar)

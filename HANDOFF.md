...
Última atualização: **2026-09-24** (cancelar item/comanda com permissão por login + histórico da comanda agrupado por pedido — ambos aguardando teste do Fabricio no app real; carrinho no "Adicionar produto direto" já testado e confirmado — ver seções próprias)
